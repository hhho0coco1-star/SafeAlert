...
| # | 작업 | 예상 소요 | 완료 |
|---|------|---------|------|
| 1-A-1 | Spring Boot 프로젝트 생성 및 의존성 설정 | 0.5일 | [ ] |
| 1-A-2 | User 엔티티, Repository 구현 | 0.5일 | [ ] |
...
| # | 작업 | 예상 소요 | 완료 |
|---|------|---------|------|
| 1-B-1 | Spring Cloud Gateway 프로젝트 생성 | 0.5일 | [ ] |
| 1-B-2 | 라우팅 설정 (각 서비스 경로 매핑) | 0.5일 | [ ] |
| 1-B-3 | JWT 인증 필터 구현 | 1일 | [ ] |
| 1-B-4 | Rate Limiting 필터 (Redis 기반) | 0.5일 | [ ] |
| 1-B-5 | K8s 배포 | 0.5일 | [ ] |
...
| # | 작업 | 예상 소요 | 완료 |
|---|------|---------|------|
| 1-C-1 | 프로젝트 생성 및 엔티티 설계 | 0.5일 | [ ] |
| 1-C-2 | 구독 CRUD API 구현 | 1일 | [ ] |
| 1-C-3 | 지역 코드 데이터 로드 (행정구역 코드) | 0.5일 | [ ] |
